...
public class ProduitController {
    ...
    public String ajouterStockAjax(@RequestParam("produitId") Long produitId,
        ...
        Optional<Produit> optProduitExistant = produitRepository.findByNomAndAgriculteur(produitSource.getNom(), producteur);
    ...
    // ✅ Page pour voir tous les produits avec leur stock et total
    ...
    @Secured("ROLE_ADMIN")
    public String modifierStock(@PathVariable Long id, @RequestParam("stock") int stock) {
        Produit produit = produitService.findById(id);
        if (produit != null) {
            produit.setStock(stock);
            produitService.saveProduit(produit);
        }
        return "redirect:/produits/stock";
    }
